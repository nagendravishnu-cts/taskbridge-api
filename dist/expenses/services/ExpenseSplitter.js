...
exports.ExpenseSplitter = void 0;
class ExpenseSplitter {
    static calculateSplit(input) {
        ...
        const participantShares = (Array.isArray(input.participants) ? input.participants : []);
    ...
    static calculateNetBalances(entries) {
...
exports.ExpenseSplitter = ExpenseSplitter;

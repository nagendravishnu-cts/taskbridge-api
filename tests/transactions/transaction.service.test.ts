...
describe('TransactionService', () => {
  ...
  beforeEach(() => {
    ...
    service = new TransactionService(repository, mockLogger as any);
  });
  ...
  describe('create', () => {
    ...
    it('should reject transactions with negative amount', async () => {
      ...
      await expect(service.create(organisationId, input)).rejects.toThrow(
    ...
    it('should reject invalid organisation ID', async () => {
      ...
      await expect(service.create(null as any, input)).rejects.toThrow(
        'Organisation ID is required'
      );
    });
  });
  ...
  describe('getByUser', () => {
    ...
    it('should reject invalid organisation ID', async () => {
      await expect(service.getByUser('', userId)).rejects.toThrow(
        'Organisation ID is required'
      );
      await expect(service.getByUser(null as any, userId)).rejects.toThrow(
        'Organisation ID is required'
      );
    });

    it('should reject invalid user ID', async () => {
      await expect(service.getByUser(organisationId, '')).rejects.toThrow(
        'User ID is required'
      );
      await expect(service.getByUser(organisationId, null as any)).rejects.toThrow(
        'User ID is required'
      );
    });
  ...
  describe('deleteAllByUser', () => {
    it('should delete all transactions for a user', async () => {
      ...
      expect(mockLogger.warn).toHaveBeenCalledWith(
        'Deleting all transactions for user',
        expect.objectContaining({
          organisationId,
          userId,
        })
    ...
    it('should reject invalid user ID', async () => {
      await expect(service.deleteAllByUser(organisationId, '')).rejects.toThrow(
        'User ID is required'
      );
    });
